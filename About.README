...
This repository contains a walkthrough of building a custom autograd (automatic gradient) engine and a neural network library from scratch. The implementation is heavily inspired by Andrej Karpathy's "The spelled-out intro to neural networks: building micrograd."

📺 Recommended Resource
For the best learning experience, it is highly recommended to code along with the original video: YouTube: Building Micrograd by Andrej Karpathy
...
🧠 Approach
The code is written step-by-step and is specifically optimized for readability. Whether you are a beginner looking to understand the "magic" behind PyTorch or an experienced developer brushing up on the fundamentals, you can follow this notebook with ease.
...
💡 Features Included
Mathematical Intuition: Every major function includes a section explaining the "Why" behind the math.
